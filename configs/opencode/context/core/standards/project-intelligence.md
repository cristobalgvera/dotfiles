...
> **Where**: `{context_root}/project-intelligence/` (dedicated folder)
...
**Full Management Guide**: See `{context_root}/core/standards/project-intelligence-management.md`
...
- **Reference**: See `{context_root}/core/context-system.md` for system overview

## Related Files

- **Management Guide**: `{context_root}/core/standards/project-intelligence-management.md`
- **Context System**: `{context_root}/core/context-system.md`
- **Standards Index**: `{context_root}/core/standards/navigation.md`
